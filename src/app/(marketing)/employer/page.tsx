    ...
    >
      <section className="px-6 py-24 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-zinc-500">
            Un désistement à 11h ? Un rush terrasse imprévu ? Trouvez un extra qualifié en moins d'une heure et déléguez toute la paperasse à Koudmain.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-zinc-500 uppercase tracking-wider">Délai moyen de matching</div>
            </div>
            ...
            <div>
              ...
              <div className="text-sm text-zinc-500 uppercase tracking-wider">Amende évitée (DPAE auto)</div>
            </div>
      ...
      <section className="bg-zinc-50 px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <h2 className="mb-16 text-center text-4xl font-black text-primary">La gestion RH, <span className="text-secondary">en mode pilotage automatique</span></h2>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="group rounded-[20px] bg-white p-10 shadow-sm border border-zinc-100 transition-all hover:shadow-xl">
              ...
              <p className="text-zinc-500 leading-relaxed">
                Koudmain génère instantanément le <strong>CDDU</strong> et réalise la <strong>DPAE</strong> auprès de l'URSSAF. Vous êtes protégé, sans lever le petit doigt.
              </p>
            </div>
            ...
            <div className="group rounded-[20px] bg-white p-10 shadow-sm border border-zinc-100 transition-all hover:shadow-xl">
              ...
              <p className="text-zinc-500 leading-relaxed">
                Accédez à des profils notés par vos confrères. Fini les "no-shows" : notre système de notation bidirectionnel assure le sérieux des extras.
              </p>
            </div>
            ...
            <div className="group rounded-[20px] bg-white p-10 shadow-sm border border-zinc-100 transition-all hover:shadow-xl">
              ...
              <p className="text-zinc-500 leading-relaxed">
                Pas de frais fixes cachés. Une commission transparente uniquement sur les missions réalisées. Rentabilisez chaque heure de travail.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-col items-center md:flex-row gap-16">
            <div className="md:w-1/2">
              <h2 className="text-4xl font-black text-primary mb-6">Reprenez le contrôle sur <span className="text-secondary">votre planning</span></h2>
      ...
      <section className="bg-primary px-6 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          <h2 className="mb-6 text-4xl font-black text-white">Prêt à sauver votre prochain service ?</h2>
          <p className="mb-10 text-zinc-400 text-lg">Rejoignez les premiers restaurateurs qui testent Koudmain et simplifiez votre gestion dès aujourd'hui.</p>
