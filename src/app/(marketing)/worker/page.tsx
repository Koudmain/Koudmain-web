          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-[20px] bg-white p-8 border border-zinc-100 shadow-sm">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Trouvez des missions pour le jour-même. Idéal pour rentabiliser un imprévu dans
            ...
            <div className="rounded-[20px] bg-white p-8 border border-zinc-100 shadow-sm">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">
                Pas de travail au noir. Chaque mission est couverte par un contrat CDDU généré
                automatiquement.
              </p>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-zinc-500 mt-2">
                  Renseignez vos expériences et vos spécialités (service, bar, cuisine). Nous
                  vérifions votre profil pour garantir la qualité du réseau.
                </p>
              </div>
            </div>
