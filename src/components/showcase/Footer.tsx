        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              La solution hybride entre l'intérim et le modèle Uber pour la restauration.
          ...
          <div>
            ...
            <ul className="space-y-3 text-zinc-300 text-sm">
              <li><a href="#" className="hover:text-secondary transition-colors">Espace Worker</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Espace Employeur</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Comment ça marche ?</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-zinc-300 text-sm">
              ...
              <li><a href="#" className="hover:text-secondary transition-colors">CGU / CGV</a></li>
